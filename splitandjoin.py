...
# Updating required packages list to include PyQt6 instead of tkinter
required_packages = ["rich", "pyfiglet", "questionary", "tqdm", "alive-progress", "PyQt6", "colorama", "termcolor", "curses", "art", "asciimatics"]
